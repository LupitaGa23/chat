...
<body>
            ...
            <div class="auth-glass">
                ...
                <form id="form-login" onsubmit="return false;">
                    ...
                    <div style="text-align:center;margin-top:10px">
                        <a href="#" onclick="mostrarRecuperarContrasena();return false;" style="color:#4fc3f7;font-size:13px;text-decoration:none">¿Olvidaste tu contraseña?</a>
                    </div>
                </form>
                ...
                <button class="btn-face-login" onclick="iniciarLoginFacial()" id="btn-face-login">
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M9 10h.01M15 10h.01M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20z"/>
                        <path d="M8 14s1.5 2 4 2 4-2 4-2"/>
                    </svg>
                    <span>Iniciar sesión con mi cara</span>
                </button>
                ...
                <!-- Modal cámara para login facial -->
                <div class="face-modal" id="face-login-modal" style="display:none;">
                    <div class="face-modal-content">
                        <h3>Reconocimiento Facial</h3>
                        <p id="face-login-status">Cargando modelos de IA...</p>
                        <div class="face-camera-container">
                            <video id="face-login-video" autoplay playsinline muted></video>
                            <canvas id="face-login-canvas"></canvas>
                            <div class="face-overlay" id="face-login-overlay"></div>
                        </div>
                        <div class="face-modal-actions">
                            <button class="btn-secondary" onclick="cerrarLoginFacial()">Cancelar</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="vista-recuperar" class="vista">
        <div class="auth-container">
            <div class="auth-glass">
                <div class="auth-logo">
                ...
                <div id="recuperar-paso1">
                    <div class="input-group">
                        ...
                        <input type="email" id="recuperar-correo" placeholder="Tu correo electrónico" required>
                    </div>
                    <button class="btn-primary" onclick="solicitarReset()">
                        <span>Enviar enlace</span>
                    </button>
                </div>

                <!-- Paso 2: Ingresar nueva contraseña (modo local) -->
                <div id="recuperar-paso2" style="display:none">
                    <div class="input-group">
                        <span class="input-icon">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                        </span>
                        <input type="password" id="recuperar-nueva" placeholder="Nueva contraseña (mín. 6 caracteres)">
                    </div>
                    <div class="input-group">
                        <span class="input-icon">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                        </span>
                        <input type="password" id="recuperar-confirmar" placeholder="Confirmar contraseña">
                    </div>
                    <button class="btn-primary" onclick="resetearContrasena()">
                        <span>Restablecer contraseña</span>
                    </button>
                </div>

                <div id="recuperar-mensaje" class="auth-message" style="display:none"></div>

                <div class="auth-divider"><span>o</span></div>
                <button class="btn-secondary" onclick="mostrarVista('vista-login')">
            ...
            <aside class="sidebar" id="sidebar">
                <div class="sidebar-header">
                    ...
                    <div class="sidebar-actions">
                        ...
                        <button class="icon-btn settings-btn" onclick="abrirPerfil()" title="Perfil y ajustes" aria-label="Perfil y ajustes">
                            <span class="settings-btn-ring"></span>
            ...
            <main class="chat-area" id="chat-area">
                ...
                <div class="chat-active" id="chat-activo" style="display:none;">
                    ...
                    <footer class="chat-footer">
                        ...
                        <button class="icon-btn btn-camara-chat" onclick="document.getElementById('input-camara').click()" title="Tomar foto">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>
                        </button>
                        <input type="file" id="input-archivo" style="display:none" onchange="enviarArchivo(this)" accept="image/*,audio/*,.pdf,.doc,.docx,.xls,.xlsx,.txt,.zip,.rar">
                        <input type="file" id="input-camara" style="display:none" onchange="enviarArchivo(this)" accept="image/*" capture="environment">

                        <button class="icon-btn mic-btn" id="btn-audio" onclick="toggleGrabacionAudio()" title="Nota de voz">
                        ...
                        <div class="message-input-wrapper">
                            ...
                            <div class="audio-recording-bar" id="audio-recording-bar" style="display:none;">
                                <span class="audio-recording-dot"></span>
                                <span id="audio-recording-text">Grabando nota de voz... toca el micrófono otra vez para enviar.</span>
                            </div>
                        </div>
    ...
    <div class="modal-overlay" id="modal-perfil" style="display:none;" onclick="if(event.target===this)cerrarPerfil()">
        <div class="modal-content modal-perfil">
            <div class="modal-header">
                <div>
                    <h3>Mi perfil</h3>
                    <p class="modal-subtitle">Edita tu foto, tus datos y tu seguridad.</p>
                </div>
            ...
            <div class="modal-body perfil-modal-body">
                <div class="perfil-avatar-panel">
                    <div class="avatar-perfil-card">
                        <div class="avatar-perfil-grande" id="perfil-avatar-preview">
                            <span id="perfil-avatar-inicial">U</span>
                        </div>
                        ...
                        <div class="perfil-avatar-actions">
                            ...
                            <button class="btn-secondary" type="button" onclick="abrirCamaraPerfil()">Tomar foto</button>
                        </div>

                        <input type="file" id="perfil-avatar-file" accept="image/*" style="display:none" onchange="subirAvatarPerfil(this)">

                        <p class="perfil-help">Puedes subir una imagen o abrir la cámara directamente si el navegador lo permite.</p>

                        <div class="camera-box" id="camera-box" style="display:none;">
                            <video id="perfil-camera-video" autoplay playsinline muted></video>
                            <canvas id="perfil-camera-canvas" style="display:none;"></canvas>
                            <div class="perfil-camera-actions">
                                <button class="btn-primary" type="button" onclick="capturarFotoPerfil()"><span>Capturar foto</span></button>
                                <button class="btn-secondary" type="button" onclick="cerrarCamaraPerfil()">Cerrar cámara</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="perfil-form-panel">
                    <div class="perfil-section-head">
                        ...
                        <p>Mantén actualizada tu información para que los demás te identifiquen mejor.</p>
                    </div>

                    <div class="perfil-grid perfil-grid-datos">
                        <div class="input-group input-full"><input type="text" id="perfil-nombre" placeholder="Nombre"></div>
                        ...
                        <div class="input-group input-full"><input type="text" id="perfil-username" placeholder="Usuario"></div>
                        <div class="input-group input-full"><input type="email" id="perfil-correo" placeholder="Correo"></div>
                        <div class="input-group input-full"><input type="text" id="perfil-telefono" placeholder="Teléfono"></div>
                    </div>

                    <div class="perfil-actions">
                        <button class="btn-primary btn-full" type="button" onclick="guardarPerfil()"><span>Guardar cambios</span></button>
                    </div>

                    <!-- Sección Reconocimiento Facial -->
                    <div class="perfil-face-box">
                        <div class="perfil-section-head">
                            <h4>Reconocimiento Facial</h4>
                            <p>Registra tu rostro para iniciar sesión sin contraseña.</p>
                        </div>
                        <div id="face-register-status" class="face-register-status">
                            <span class="face-status-icon" id="face-status-icon">&#x1F6AB;</span>
                            <span id="face-status-text">Sin rostro registrado</span>
                        </div>
                        <div class="face-camera-container face-register-camera" id="face-register-camera" style="display:none;">
                            <video id="face-register-video" autoplay playsinline muted></video>
                            <canvas id="face-register-canvas"></canvas>
                            <div class="face-overlay" id="face-register-overlay"></div>
                        </div>
                        <div class="perfil-actions">
                            <button class="btn-primary btn-full" type="button" id="btn-registrar-cara" onclick="iniciarRegistroCara()">
                                <span>Registrar mi rostro</span>
                            </button>
                            <button class="btn-secondary btn-full" type="button" id="btn-cancelar-cara" style="display:none;" onclick="cancelarRegistroCara()">
                                Cancelar captura
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="perfil-password-box">
                        <div class="perfil-section-head">
                            ...
                            <p>Usa una contraseña segura y evita compartirla.</p>
                        </div>

                        <div class="perfil-grid perfil-grid-pass">
                            <div class="input-group input-full"><input type="password" id="perfil-pass-actual" placeholder="Contraseña actual"></div>
                        ...
                        <div class="perfil-actions">
                            <button class="btn-secondary btn-full" type="button" onclick="cambiarPasswordPerfil()">Actualizar contraseña</button>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\Users\andyg\OneDrive\Desktop\CHUCHO FACE 3\darkgray-chamois-716831.hostingersite.com\public_html\resources\views/chat.blade.php ENDPATH**/ ?>